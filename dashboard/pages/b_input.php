        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <form role="form" action="pages/p_buku/p_binput.php" method="POST"
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="number" placeholder="Masukkan Nama Penulis"
                                    name="nama">
                                <?php
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <select
                                    ...
                                    <option value="<?php echo $var ['kode']; ?>"
                                        <?php echo (isset($_SESSION['value']['kategori']) && $_SESSION['value']['kategori'] == $var['kode'])? 'selected': ''; ?>>
                                        <?php echo $var['nama']; ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                            <div class="form-group">
