...
<head>
    ...
    <!-- MetisMenu CSS -->
    <link href="dashboard/assets/css/metisMenu.min.css" rel="stylesheet">

    <!-- Custom CSS -->
    <link href="dashboard/assets/css/startmin.css" rel="stylesheet">

    <!-- Custom Fonts -->
    <link href="dashboard/assets/css/font-awesome.min.css" rel="stylesheet" type="text/css">
...
<body>
            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    ...
                    <div class="panel-body">
                        <form role="form" action="dashboard/pages/proses/login_proses.php" method="post">
                            <fieldset>
    ...
    <!-- jQuery -->
    <script src="dashoardassets/js/jquery.min.js" type="text/javascript"></script>

    <!-- Bootstrap Core JavaScript -->
    <script src="dashboard/assets/js/bootstrap.min.js" type="text/javascript"></script>

    <!-- Metis Menu Plugin JavaScript -->
    <script src="dashboard/assets/js/metisMenu.min.js" type="text/javascript"></script>

    <!-- Custom Theme JavaScript -->
    <script src="dashboard/assets/js/startmin.js" type="text/javascript"></script>
